...
namespace Rum.People
{
    ...
    public class PersonService : RestServiceBase<Person>
    {
        ...
        public override object OnGet(Person request)
        {
            ...
            return new PersonResponse { Person = person, Label = person.Display, ResponseStatus = new ResponseStatus() };
        }
        ...
        public override object OnGet(Storage request)
        {
            DbFactory.Exec(dbCmd =>
            {
                ...
                using (var trans = dbCmd.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    ...
                    dbCmd.Insert(new Person { Id = 1, Parent = 0, FirstName = "Lenka", LastName = "Stikova", DateOfBirth = DateTime.Parse("27/05/1967", new CultureInfo("en-GB", false)) });
                    dbCmd.Insert(new Person { Id = 2, Parent = 0, FirstName = "Gary", LastName = "MacDonald", DateOfBirth = DateTime.Parse("27/05/1967", new CultureInfo("en-GB", false)) });
                    dbCmd.Insert(new Person { Id = 3, Parent = 1, FirstName = "Michaela", LastName = "MacDonald", DateOfBirth = DateTime.Parse("23/07/1985", new CultureInfo("en-GB", false)) });
                    dbCmd.Insert(new Person { Id = 4, Parent = 3, FirstName = "Arthur", LastName = "MacDonald", DateOfBirth = DateTime.Parse("22/12/2010", new CultureInfo("en-GB", false)) });
                    dbCmd.Insert(new Person { Id = 5, Parent = 3, FirstName = "Robert", LastName = "MacDonald", DateOfBirth = DateTime.Parse("14/2/2012", new CultureInfo("en-GB", false)) });
                    dbCmd.Insert(new Person { Id = 6, Parent = 3, FirstName = "Ruby", LastName = "MacDonald", DateOfBirth = DateTime.Parse("14/2/2014", new CultureInfo("en-GB", false)) });

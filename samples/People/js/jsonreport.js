...
var cssText =
  ...
  ".jsonreport TH, .jsonreport TD, .jsonreport TD DT, .jsonreport TD DD { font-size: 9px; }\r\n" +
  ".jsonreport TD { padding: 5px 5px 0 5px; vertical-align: top; }\r\n" +
  ".jsonreport DL { clear: left; }\r\n" +
  ".jsonreport DT { margin: 6px 0 3px 0; font: bold 12px; width: 200px; clear: left; /* float: left; */ display:block; white-space:nowrap; }\r\n" +
  ".jsonreport DD { margin: 3px 6px; font: 12px Arial; padding: 2px; display: block; /* float: left; */ }\r\n" +
  ".jsonreport DL DL DT { font: bold 10px; }\r\n" +
  ".jsonreport DL DL DD { font-size: 10px; }\r\n" +
  ".jsonreport HR { display:none; }\r\n" +
  ".jsonreport TD DL HR { display:block; padding: 0; clear: left; border: none; }\r\n" +
  ".jsonreport TD DL { padding: 2px; margin: 0; height:100%; max-width: 700px; }\r\n" +
  ".jsonreport DL TD DL DT { padding: 2px; margin: 0 6px 0 0; font-weight: bold; font-size: 10px; width: 120px; overflow: hidden; clear: left; float: left; display:block; }\r\n" +
  ".jsonreport DL TD DL DD { margin: 0; padding: 2px; font-size: 10px; display: block; /* float: left; */ }\r\n" +
  ".jsonreport TBODY>TR:last-child>TD { padding: 3px; }\r\n" +
  ...
  ".jsonreport TH B { display:block; float:right; margin: 0 0 0 3px; width: 0; height: 0; border-left: 3px solid transparent; border-right: 3px solid transparent; border-top: 3px solid #ccc; border-bottom: none; }\r\n" +
  ".jsonreport .asc B { border-left: 3px solid transparent; border-right: 3px solid transparent; border-top: 3px solid #333; border-bottom: none; }\r\n" +
  ".jsonreport .desc B { border-left: 3px solid transparent; border-right: 3px solid transparent; border-bottom: 3px solid #333; border-top: none; }\r\n" +
  ".jsonreport H3 { font-size: 12px; margin: 0 0 6px 0; }";
